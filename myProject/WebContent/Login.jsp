...
<div id="body-content">
	<div id="banner"></div>
   	...
   	<div id="center">   			        
	   	<h4>Bienvenido</h4>
	   	<h5>En el siguiente sistema, el Coordinador docente puede realizar la evaluación correspondiente a<br/>
	   	  	las actividades docentes realizadas por los profesores con motivo de renovar su contratración <br/>
